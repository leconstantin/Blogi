...
import { FaBookmark, FaCommentDots, FaRegCommentDots } from "react-icons/fa";
    ...
    <main className="flex flex-col space-y-5">
      <div className="rounded-lg bg-vc-border-gradient p-px shadow-lg shadow-black/20">
        <div className="flex flex-col items-center rounded-lg bg-black p-3.5 lg:p-6">
          {/* top section */}
          <div className="flex justify-between w-full pb-2 border-b-2 border-zinc-800">
            <div className="flex items-start space-x-2">
              ...
              <div>
                ...
                <div className="text-blue-500">Software Engineer</div>
              </div>
            </div>
            <div>Education</div>
          </div>
          {/* middle content */}
          <div className="text-justify line-clamp-3 pt-2 text-base text-zinc-300 tracking-wide text-balance">
          ...
          <div></div>
          {/* actions */}
          <div className="flex justify-between w-full pt-2 border-t-2 border-zinc-800 mt-2">
            <div className="flex space-x-4">
              <button className="flex items-center space-x-1 text-zinc-300 hover:text-white">
                <AiFillLike className="size-4 text-blue-500" />
                <span>Like</span>
              </button>
              <button className="flex items-center space-x-1 text-zinc-300 hover:text-white">
                <FaCommentDots className="size-4 text-blue-500" />
                <span>Comment</span>
              </button>
              <button className="flex items-center space-x-1 text-zinc-300 hover:text-white">
                <FaBookmark className="size-4 text-blue-500" />
                <span>Bookmark</span>
              </button>
            </div>
